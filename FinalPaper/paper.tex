...
we identified some issues with the domains, to make it less interesting for
FF-Replan (in the case of the \textsc{Traffic} domain), of how to make a domain
more interesting for a replanner in the \textsc{Navigation} domain. The UAV
domain seems to have resemblances of the \textsc{Navigation} domain and the
