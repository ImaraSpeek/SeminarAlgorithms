...
other domains used in the IPPC and compare that with the UAV domain. Since
Little and Thi\'ebauw's baseline test for \emph{probabilistic interestingness}
of domains, domains of the IPPC competition have shifted to those
probabilistically interesting domains, which are difficult for replanners.
Often domains that don't pass this test are deemed to be classical planners in
disguise, favoring the use of replanners.
