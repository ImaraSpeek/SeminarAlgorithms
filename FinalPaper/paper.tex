...
\todo{TODO maybe UAVs can be on or of too, so it's forced to use a further UAV.}
\todo{TODO what's also interesting is that Amazon.com uses drones for package deliveries}
