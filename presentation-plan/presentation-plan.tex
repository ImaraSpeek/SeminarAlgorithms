...
\subsubsection{Introducing the FF planner}

\subsubsection{2000 - 2005}

\subsubsection{FF-Replan}

\subsubsection{RFF}

\subsubsection{Compare FF-Replan with RFF}

\subsubsection{How did FF-Replan inspire}

\subsubsection{Alternatives FF-Replan}

\subsubsection{What after? Any new methods}

\subsection{Present goal of paper}

\subsection{Is it time to reconsider classical planners}
