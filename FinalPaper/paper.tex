...
Finally we described to other relevant planners RFF and PROST\. RFF is a
planner similar to FF-Replan, but instead works off-line and generates
policies. PROST is a UTC based probabilistic planner that outperformed
\textsc{Gourmand}'s predecessor \textsc{Glutton}.
