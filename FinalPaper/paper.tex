...
\title{Validating FF-Replan vs. a state-of-the-art propabilistic planner in a real world domain}
...
\begin{itemize}
	...
	\item Show PPDDL or RDDL of domain (probabilistic extension of PDDL)
\end{itemize}
...
\section{Domain description}
% Stukje voor domein
Following the theoretical comparison of probabilistic planning and replanning techniques by Little and Thiébauw a baseline test for \emph{probabilistically interesting} domains is proposed. Problems that fail this test were deemed to be classical planning problems in disguise \cite{little2007probvsreplan}. To validate our planners in a real-world domain we will analyze previous and current domain description for the 'probabilistically interestingness' using this baseline test, adjust them to what we consider as being a real-world domain and test it again. Using these   
...
\subsection{Planning problem definition}
