...
FF-Replan and \textsc{Gourmand} are top-performing planners at the time they
were introduced for the domains described earlier. Two other planners are
\textsc{RFF}, an offline policy planner using FF, and PROST, a UCT algorithm
based planner.

RFF \cite{teichteil2010incremental} generates policies by determinizing the
