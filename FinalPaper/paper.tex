...
of domains, domains have shifted to those probabilistically interesting
domains, which are difficult for replanners. Often domains that don't pass
this test are deemed to be classical planners in disguise, favoring the use of
replanners.
