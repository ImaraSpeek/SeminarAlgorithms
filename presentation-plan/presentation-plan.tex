...
\subsection{Introduction to a planner (A)}
...
\subsection{What is uncertainty (I)}

\subsubsection{Domains \& Applications (I)}

\subsection{Historic Overview}

\subsubsection{$<$ 1990 (A)}
...
\subsubsection{Introducing the FF planner (I)}

\subsubsection{2000 - 2005 (A)}

\subsubsection{FF-Replan (I)}

\subsubsection{RFF (A)}

\subsubsection{Compare FF-Replan with RFF (I\&A)}

\subsubsection{How did FF-Replan inspire (I)}

\subsubsection{Alternatives FF-Replan ()}

\subsubsection{What after? Any new methods (A)}

\subsection{Present goal of paper (I\&A)}

\subsection{Is it time to reconsider classical planners (I\&A)}
